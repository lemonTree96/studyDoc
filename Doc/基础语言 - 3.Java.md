...
&emsp; &emsp; TTL为了能够在子线程池化复用的过程中保持变量数据的一致性，实现了CRR模式 `(capture[抓取]，replay[回放]，restore[恢复])`

<img src="../picOfDoc/image-20210722002238515.png" alt="image-20210722002238515" style="zoom:23%;" />
